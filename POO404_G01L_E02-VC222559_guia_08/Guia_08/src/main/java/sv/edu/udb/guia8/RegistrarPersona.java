    ...
    private void processRequest(final HttpServletRequest request, final HttpServletResponse
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                final String query = "INSERT INTO persona(nombre_persona, edad_persona, sexo_persona, id_ocupacion, fecha_nac, usuario, contrasenia) " + "VALUES ('" + nombre + "'," + edad + ", '" + sexo + "' , " + idocupacion + ", '" + fecha + "' ,'" + usuario + "', '" + password + "' )";
